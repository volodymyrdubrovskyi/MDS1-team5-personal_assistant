...
def show_help():
    commands = [['Command', 'Parameters', 'Description'],
                   ...
                   ['find-notes', '[serchstring]', 'list all Notes with [serchstring] data in note and tags.[serchstring] must be 2 symbols minimum'],
                   ['find-tags', '[serchstring]', 'list all Notes with [serchstring] data in tags.[serchstring] must be 2 symbols minimum'],
